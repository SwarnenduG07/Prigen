        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              At Prigen, we believe file sharing should be simple, secure, and
              lightning-fast. Our mission is to provide the most reliable and
              user-friendly file sharing platform while maintaining the highest
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed">
                  We prioritize your data security with end-to-end encryption
                  and zero-knowledge privacy. Your files are only accessible to
              ...
              <div>
                ...
                <p className="text-gray-400 leading-relaxed">
                  Using cutting-edge technology and optimized infrastructure, we
                  ensure your files are transferred at the highest possible
                  speeds.
                </p>
              </div>
            </div>
