            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {['file', 'email', 'password', 'date'].map((field, index) => (
                ...
                >
                  {field === 'file' && (
                    <div className=''>
                      <label className="block text-lg font-bold dark:text-blue-100 mb-2">File</label>
                      <motion.input
                  ...
                  {field === 'email' && (
                    <div>
                      <label className="block text-lg font-bold dark:text-blue-100 mb-2">Recipient Email</label>
                      <motion.input
                        whileHover={{ scale: 1.01 }}
                        type="email"
                  ...
                  {field === 'password' && (
                    <div>
                      <label className="block text-lg font-bold dark:text-blue-100 mb-2">Password</label>
                      <motion.input
                        whileHover={{ scale: 1.01 }}
                        type="password"
                        value={password}
                  ...
                  {field === 'date' && (
                    <div>
                      <label className="block text-lg font-bold dark:text-blue-100">Expiration Date</label>
                      <motion.input
                        whileHover={{ scale: 1.01 }}
                        type="datetime-local"
