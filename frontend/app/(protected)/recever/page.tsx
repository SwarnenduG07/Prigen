...
const passwordSchema = z.object({
  password: z.string().min(6, { message: "Passowrd must be 6 character long" }),
});
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-800/5">
                      <TableHead className="font-bold text-gray-100">
                        File Name
                      </TableHead>
                      <TableHead className="font-bold text-gray-100">
                        Size
                            ...
                            <DialogContent className="bg-gray-800/80 backdrop-blur-md border border-gray-700/20">
                              ...
                              <Form {...form}>
                                ...
                                >
                                  ...
                                  />
                                  <Button className="w-full bg-purple-500 rounded-md">
                                    Submit
                                  </Button>
                                </form>
                              </Form>
